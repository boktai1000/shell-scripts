...
# curl -s https://raw.githubusercontent.com/boktai1000/shell-scripts/master/applications/fluentd/nix-install-fluentd-v3.sh | sudo bash
# curl -s https://bitbucket.org/boktai1000/shell-scripts/raw/master/applications/fluentd/nix-install-fluentd-v3.sh | sudo bash

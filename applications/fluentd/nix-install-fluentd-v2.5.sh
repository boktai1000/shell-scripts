...
# curl -s https://raw.githubusercontent.com/boktai1000/shell-scripts/master/applications/fluentd/nix-install-fluentd-v2.5.sh | sudo bash
# curl -s https://bitbucket.org/boktai1000/shell-scripts/raw/master/applications/fluentd/nix-install-fluentd-v2.5.sh | sudo bash

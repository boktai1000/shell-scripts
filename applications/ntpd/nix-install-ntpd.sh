...
# curl -s https://raw.githubusercontent.com/boktai1000/shell-scripts/master/applications/ntpd/nix-install-ntpd.sh | sudo bash -s 
# curl -s https://bitbucket.org/boktai1000/shell-scripts/raw/master/applications/ntpd/nix-install-ntpd.sh | sudo bash -s 

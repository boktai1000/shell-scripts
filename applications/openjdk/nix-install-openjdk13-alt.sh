...
# source <(curl -s https://raw.githubusercontent.com/boktai1000/shell-scripts/master/applications/openjdk/nix-install-openjdk13-alt.sh)
# source <(curl -s https://bitbucket.org/boktai1000/shell-scripts/raw/master/applications/openjdk/nix-install-openjdk13-alt.sh)
...
alternatives --install /usr/bin/java java /opt/jdk-13.0.2/bin/java 1000
alternatives --set java /opt/jdk-13.0.2/bin/java
